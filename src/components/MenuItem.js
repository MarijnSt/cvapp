...
const MenuItem = ({item, handleClick}) => {
    const showSVG = () => {
        if (item === 'Home') {
            return (
                <svg className={item} version="1.1" baseProfile="tiny" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xmlSpace="preserve">
            ...
            return (
                <svg className={item} version="1.1" baseProfile="tiny" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
	 viewBox="0 0 80 80" xmlSpace="preserve">
		            <path d="M79.8,60.7c-0.7-2.2-1.9-4.2-3.5-5.8c-2.6-2.6-6.2-4.1-9.8-4.1c-1.9,0-3.8,0.4-5.5,1.1L47.3,38.2l18.2-18
            ...
            return (
                <svg className={item} version="1.1" baseProfile="tiny" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
	 viewBox="0 0 80 80" xmlSpace="preserve">
                    <path d="M73.3,16.7H56.7v-3.3c0-3.7-3-6.7-6.7-6.7H30c-3.7,0-6.7,3-6.7,6.7v3.3H6.7c-3.7,0-6.7,3-6.7,6.7v43.3
            ...
            return (
                <svg className={item} version="1.1" baseProfile="tiny" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
	 viewBox="0 0 80 80" xmlSpace="preserve">
	                <path d="M74.7,20.3c-3.6-6.1-8.4-10.9-14.5-14.5c-6.1-3.6-12.7-5.3-19.9-5.3c-7.2,0-13.9,1.8-19.9,5.3
		...
		c0,0.6,0.2,1.1,0.6,1.6c0.4,0.4,1.1,0.5,2,0.4c8-2.7,14.5-7.4,19.6-14.4c5.1-6.9,7.6-14.7,7.6-23.4C80,33,78.2,26.4,74.7,20.3z"/>
            ...
            return (
                <svg className={item} version="1.1" baseProfile="tiny" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
	 viewBox="0 0 80 80" xmlSpace="preserve">
		            <path d="M70.5,9.3h-61c-5.4,0-9.9,4.4-9.9,9.9v41.7c0,5.4,4.4,9.9,9.9,9.9h61c5.4,0,9.9-4.4,9.9-9.9V19.2
			...
			c3,0,5.4,2.4,5.4,5.4L75.9,60.8L75.9,60.8z"/>
		            <path d="M50.5,39.5l19.7-17.7c0.9-0.8,1-2.3,0.2-3.2c-0.8-0.9-2.3-1-3.2-0.2L40,42.9l-5.3-4.7c0,0,0,0,0-0.1
    ...
    const menuItem = `menu-item ${item}`
    const hiddenP = `hidden ${item}`

    return (
        <div className={menuItem} onClick={handleClick}>
            {showSVG()}
            <p className={hiddenP}>{item}</p>
        </div>
    )
}
